...
- Use the segmented **Originals / Edited / Both** picker in the toolbar to choose which
  versions to export. Edited exports add an `_edited` suffix and only apply to assets that
  have edits in Photos.
